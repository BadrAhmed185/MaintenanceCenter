        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientEntityName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DelivererName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DelivererPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeviceCondition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    TechnicalReport = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_AspNetUsers_ReceptionistId",
                        column: x => x.ReceptionistId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_AspNetUsers_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_Workshops_WorkshopId",
                        column: x => x.WorkshopId,
                        principalTable: "Workshops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentReceipts_MaintenanceRequests_MaintenanceRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestService", x => new { x.MaintenanceRequestId, x.MaintenanceServiceId });
                    table.ForeignKey(
                        name: "FK_RequestService_MaintenanceRequests_MaintenanceRequestId",
                        column: x => x.MaintenanceRequestId,
                        principalTable: "MaintenanceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestService_MaintenanceServices_MaintenanceServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestSparePart", x => new { x.MaintenanceRequestId, x.SparePartId });
                    table.ForeignKey(
                        name: "FK_RequestSparePart_MaintenanceRequests_MaintenanceRequestId",
                        column: x => x.MaintenanceRequestId,
                        principalTable: "MaintenanceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestSparePart_SpareParts_SparePartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_ReceptionistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_WorkshopId",
                table: "MaintenanceRequests",
                column: "WorkshopId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentReceipts_MaintenanceRequestId",
                table: "PaymentReceipts",
                column: "MaintenanceRequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RequestService_MaintenanceServiceId",
                table: "RequestService",
                column: "MaintenanceServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestSparePart_SparePartId",
                table: "RequestSparePart",
                column: "SparePartId");
        }
